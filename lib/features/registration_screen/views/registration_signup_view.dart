...
class _RegisterSignUpViewState extends State<RegisterSignUpView>
  ...
  void handleAccountRegistration() async {
    final url = NetworkHelper.current.constructURL(NetworkServiceEndpoints.auth, NetworkServiceSubEndpoints.register);
    print(url);
    return;
      ...
      child: Column(
        children: [
          ...
          StandardButtonWithDismissKeyboardComponent(
            ...
            onTap: handleAccountRegistration,
