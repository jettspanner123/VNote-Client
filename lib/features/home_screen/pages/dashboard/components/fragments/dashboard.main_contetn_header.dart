...
class _DashboardMainContentHeaderState extends State<DashboardMainContentHeaderController> {
  ...
  Widget build(BuildContext context) {
    ...
    return Row(
      ...
      children: [
        CircleAvatar(radius: 25, backgroundColor: ColorFactory.accentColor),
        ...
        Column(
          ...
          children: [
            Text(
              ...
              style: UIHelper.current.funnelTextStyle(
                ...
                color: UIHelper.current.getValueAccordingToColorMode(
                  ...
                  darkValue: Colors.white.withAlpha(80),
                  lightValue: Colors.black.withAlpha(50),
                ),
                height: 0.6,
              ),
            ),
            ColorModeAwareTextComponent(
              text: "Uddeshya",
              style: UIHelper.current.funnelTextStyle(fontSize: 23, fontWeight: FontWeight.bold),
            ),
          ],
        ),
        Spacer(),
        AppbarActionButton(
          child: Icon(
            globalColorModeBloc.state.colorMode == AppColorMode.LIGHT ? Icons.dark_mode : Icons.light_mode,
