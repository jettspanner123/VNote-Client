...
class DashboardNumberButtonComponent extends StatelessWidget {
  final String value;
  final VoidCallback onTap;

  const DashboardNumberButtonComponent({super.key, required this.value, required this.onTap});
  ...
  Widget build(BuildContext context) {
    ...
    return OnTapScaleInteractionComponent(
      ...
      child: Container(
        ...
        child: Center(
          child: value == DashboardMoneyRequestConstants.current.NUMBER_BUTTON_BACKSPACE_IDENTIFIER
              ? Icon(
              ...
              : ColorModeAwareTextComponent(
                  text: value,
                  style: UIHelper.current.funnelTextStyle(fontSize: 22, fontWeight: FontWeight.w500),
                ),
        ),
      ),
    );
