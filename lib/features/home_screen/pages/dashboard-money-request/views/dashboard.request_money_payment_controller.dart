...
class DashboardRequestMoneyPaymentController extends StatefulWidget {
  final String initialValue;
  final void Function(String value)? onValueChanged;
  final VoidCallback selectUserButtonAction;

  const DashboardRequestMoneyPaymentController({
    super.key,
    this.initialValue = "0",
    this.onValueChanged,
  ...
  @override
  State<DashboardRequestMoneyPaymentController> createState() => DashboardRequestMoneyPaymentControllerState();
}

class DashboardRequestMoneyPaymentControllerState extends State<DashboardRequestMoneyPaymentController> {
  // Mutable value lives in state, seeded from the widget prop.
