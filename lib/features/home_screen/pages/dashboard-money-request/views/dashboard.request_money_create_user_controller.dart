...
class DashboardRequestMoneyCreateUserController extends StatefulWidget {
  final void Function({required String fullName, required String phoneNumber, String? email})? onSubmit;

  const DashboardRequestMoneyCreateUserController({super.key, this.onSubmit});

  @override
  State<DashboardRequestMoneyCreateUserController> createState() => DashboardRequestMoneyCreateUserControllerState();
}

class DashboardRequestMoneyCreateUserControllerState extends State<DashboardRequestMoneyCreateUserController> {
