...
class _RequestMoneyUser {
  final String name;
  final String contact; // phone or email
  final String initials;
  final Color avatarColor;

  const _RequestMoneyUser({
    required this.name,
...
class DashboardRequestMoneySelectUserController extends StatefulWidget {
  final void Function(_RequestMoneyUser user)? onUserSelected;

  const DashboardRequestMoneySelectUserController({super.key, this.onUserSelected});

  @override
  State<DashboardRequestMoneySelectUserController> createState() => _DashboardRequestMoneySelectUserControllerState();
}

class _DashboardRequestMoneySelectUserControllerState extends State<DashboardRequestMoneySelectUserController> {
  // Placeholder data — swap with real data source when ready.
  static const List<_RequestMoneyUser> _users = [
    _RequestMoneyUser(name: "Aarav Sharma", contact: "+91 98765 43210", initials: "AS", avatarColor: Color(0xFF57944D)),
    _RequestMoneyUser(
      name: "Priya Mehta",
    ...
    _RequestMoneyUser(name: "Rohan Verma", contact: "+91 91234 56789", initials: "RV", avatarColor: Color(0xFFE07B39)),
    _RequestMoneyUser(
      name: "Sneha Kapoor",
    ...
    _RequestMoneyUser(name: "Karan Patel", contact: "+91 87654 32109", initials: "KP", avatarColor: Color(0xFFE74C3C)),
    _RequestMoneyUser(
      name: "Divya Nair",
    ...
    _RequestMoneyUser(name: "Arjun Singh", contact: "+91 99887 76655", initials: "AR", avatarColor: Color(0xFFF39C12)),
  ];
