      ...
      child: Column(
        children: [
          ...
          Container(
            ...
            height: 4.5,
            decoration: BoxDecoration(
              color: colorMode == AppColorMode.LIGHT ? Colors.black.withAlpha(30) : Colors.white.withAlpha(30),
                ...
                children: [
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      border: Border.all(color: _getStatusColor(transaction.transactionStatus).withAlpha(50), width: 1),
                    ),
                    child: Row(
          ...
          // Bottom Close action (stretched to full width)
          Padding(
            padding: const EdgeInsets.only(left: 20, right: 20, bottom: 30, top: 10),
            child: SizedBox(
              width: double.infinity,
              child: StandardButtonComponent(
                backgroundColor: colorMode == AppColorMode.LIGHT 
                    ? Colors.black 
                    : Colors.white,
                ...
                child: SizedBox(
                  ...
                  child: StandardButtonText(
                    text: "Done",
                    foregroundColor: colorMode == AppColorMode.LIGHT 
                        ? Colors.white 
                        : Colors.black,
                  ),
                ),
            ...
            children: [
              ...
              Text(
                ...
                style: useOswald
                    ...
                    : UIHelper.current.funnelTextStyle(
                        fontSize: 13.5,
                        fontWeight: FontWeight.w700,
                        color: textColor,
                      ),
