...
class ApplicationBarSearchButtonComponent extends StatefulWidget {
  final VoidCallback? onTap;
  const ApplicationBarSearchButtonComponent({super.key, this.onTap});

  @override
  State<ApplicationBarSearchButtonComponent> createState() => ApplicationBarSearchButtonComponentState();
}

class ApplicationBarSearchButtonComponentState extends State<ApplicationBarSearchButtonComponent> {
  bool isTapped = false;
    ...
    return Transform.translate(
      ...
      child: Listener(
        ...
        child: GestureDetector(
          onTap: widget.onTap ?? () {
            Navigator.pushNamed(context, NavigationFactory.transactionSearchScreen);
          },
          child: AnimatedScale(
